...
class model_gnn(nn.Module):
    ...
    def forward(self, A):
        ...
        p_conv1 = self.gcn1_p(None, s_feature_p)
        p_conv2 = self.gcn2_p(p_conv1, s_feature_p)
        n_conv1 = self.gcn1_n(None, s_feature_n)
        n_conv2 = self.gcn2_n(n_conv1, s_feature_n)
